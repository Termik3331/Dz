class Student:
    ...
    def srgr(self):
        if not self.grades:
            return 0
        elif isinstance(self.grades, int):
            return self.grades
        spisok = []
...
student_2.rate_hw(best_lecturer_2, 'Git', 5)
...
cool_rewiewer_2.rate_hw(student_2, 'Git', 8)
cool_rewiewer_2.rate_hw(student_2, 'Git', 7)
cool_rewiewer_2.rate_hw(student_2, 'Git', 9)
